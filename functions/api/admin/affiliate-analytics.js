...
export async function onRequestGet({request,env}){
   ...
   * UNIQUE VISITORS
   *
   * This remains based on anonymous affiliate-page traffic.
   * It is not linked to an affiliate account, therefore
   * is_test_account cannot be applied here.
   */
  ...
  /*
   * APPLICATIONS
   * Exclude internal QA/test affiliate accounts.
   */
  ...
  /*
   * ACTIVE AFFILIATES
   * At least one valid paid sale in the month.
   * QA/test affiliates excluded.
   */
   ...
   * QA/test affiliate sales excluded.
   */
