...
async function serviceStats(db,row){
  // Revenue is linked automatically when a matching product exists in QY Products.
  // Match by explicit product_id first, otherwise exact service name.
