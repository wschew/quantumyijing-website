...
export async function onRequestPost({request,env}){
 ...
 const p=await db.prepare("SELECT p.*,a.full_name,a.email,a.affiliate_code FROM affiliate_payouts p JOIN affiliates a ON a.id=p.affiliate_id WHERE p.id=?").bind(id).first();
