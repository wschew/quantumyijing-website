(() => {
  ...
  async function savePayment(){
    try{
      ...
      setMessage('paymentDialogMessage',`Payment record saved. Net ${money(data.netAmount,currency)} · Bank received ${bankText}.`,true);
