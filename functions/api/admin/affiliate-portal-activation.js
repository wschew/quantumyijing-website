...
Activate Your Affiliate Portal
</h1>
...
Your Quantum YiJing® Affiliate account has been approved and is ready for portal activation.
</p>

<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
style="margin:24px 0;background:#f7faff;border:1px solid #dce8f6;border-radius:12px">
<tr>
<td style="padding:13px 16px;color:#58708d;font-size:13px;width:145px">Affiliate Code</td>
<td style="padding:13px 16px;font-size:13px;font-weight:700;color:#173b63">${safeCode||'—'}</td>
</tr>
<tr>
<td style="padding:13px 16px;color:#58708d;font-size:13px;border-top:1px solid #e3edf8">Activation Link</td>
<td style="padding:13px 16px;font-size:13px;font-weight:700;color:#173b63;border-top:1px solid #e3edf8">Valid for 7 days</td>
</tr>
</table>

<p style="margin:0 0 22px;font-size:15px;line-height:1.75">
Please click the button below to create your password and activate your private Affiliate Portal.
</p>

<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 24px">
<tr><td align="center" bgcolor="#1768c4" style="border-radius:8px">
<a href="${safeLink}"
style="display:inline-block;padding:14px 24px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700">
Activate Affiliate Portal
</a>
</td></tr>
</table>

<p style="margin:0 0 16px;font-size:12px;line-height:1.7;color:#71839a">
For security, this activation link expires in 7 days. If the button does not work, copy and paste this URL into your browser:<br>
<span style="word-break:break-all;color:#1768c4">${safeLink}</span>
</p>
...
您的 Quantum YiJing® 联盟账户已获批准，现在可以启用私人联盟平台。
</p>

<p style="margin:18px 0;font-size:15px;line-height:1.85">
<strong>联盟编号：</strong> ${safeCode||'—'}<br>
<strong>启用链接有效期：</strong> 7 天
</p>
...
<p style="margin:0 0 16px;font-size:12px;line-height:1.85;color:#71839a">
为了账户安全，此启用链接将在 7 天后失效。如果按钮无法打开，请复制以下网址到浏览器：<br>
<span style="word-break:break-all;color:#1768c4">${safeLink}</span>
</p>
