...
- Rebuilt the Research hero, pillars, inquiry fields, philosophy, roadmap, publications and collaboration sections.
- Added uniquely prefixed `research-v182-*` classes to eliminate selector conflicts.
- Added high-specificity dedicated styling in `research.css`.
